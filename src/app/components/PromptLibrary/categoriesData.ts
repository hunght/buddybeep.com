...
export const agentsCategorization = [
  ...
  { agentId: 'svg-designer', category: 'Art and Design', subCategory: 'Digital Art' },
  ...
  { agentId: 'life-coach', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  { agentId: 'career-counselor', category: 'Educational', subCategory: 'Learning Aids' },
  { agentId: 'mental-health-adviser', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  { agentId: 'doctor', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  { agentId: 'automobile-mechanic', category: 'Educational', subCategory: 'STEM' },
  { agentId: 'self-help-book', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  ...
  { agentId: 'advertiser', category: 'Social Media and Marketing', subCategory: 'Branding' },
  { agentId: 'motivational-coach', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  ...
  { agentId: 'social-media-manager', category: 'Social Media and Marketing', subCategory: 'Social Media Content' },
  ...
  { agentId: 'data-scientist', category: 'Research and Development', subCategory: 'Scientific Research' },
  ...
  { agentId: 'relationship-coach', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  { agentId: 'rapper', category: 'Art and Design', subCategory: 'Music Composition' },
  ...
  { agentId: 'ai-assisted-doctor', category: 'Research and Development', subCategory: 'Medical Research' },
  { agentId: 'chef', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  { agentId: 'artist-advisor', category: 'Art and Design', subCategory: 'Consultation' },
  ...
  { agentId: 'social-media-influencer', category: 'Social Media and Marketing', subCategory: 'Social Media Content' },
  { agentId: 'yogi', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  { agentId: 'elocutionist', category: 'Educational', subCategory: 'Language Learning' },
  { agentId: 'hypnotherapist', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  ...
  { agentId: 'digital-art-gallery-guide', category: 'Art and Design', subCategory: 'Digital Art' },
  { agentId: 'public-speaking-coach', category: 'Educational', subCategory: 'Learning Aids' },
  { agentId: 'makeup-artist', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  { agentId: 'babysitter', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  ...
  { agentId: 'virtual-doctor', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  ...
  { agentId: 'dream-interpreter', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  ...
  { agentId: 'salesperson', category: 'Social Media and Marketing', subCategory: 'Sales Techniques' },
  { agentId: 'song-recommender', category: 'Entertainment', subCategory: 'Music' },
  { agentId: 'technology-transferer', category: 'Research and Development', subCategory: 'Engineering Solutions' },
  ...
  { agentId: 'personal-trainer', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  ...
  { agentId: 'dietitian', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  ...
  { agentId: 'emergency-response-professional', category: 'Personal Use', subCategory: 'Personal Health and Wellness' },
  ...
  { agentId: 'speech-language-pathologist-slp', category: 'Personal Use', subCategory: 'Health and Wellness' },
  ...
  { agentId: 'seo-prompt', category: 'Social Media and Marketing', subCategory: 'SEO Optimization' },
  { agentId: 'psychologist', category: 'Personal Use', subCategory: 'Health and Wellness' },
  { agentId: 'dentist', category: 'Personal Use', subCategory: 'Health and Wellness' },
  ...
  { agentId: 'web-design-consultant', category: 'Art and Design', subCategory: 'Digital Art' },
