...
const subcategoryIcons = {
  'Architectural Design': 'fas fa-building',
  'Digital Art': 'fas fa-pencil-ruler',
  'Music Composition': 'fas fa-music',
  Consultation: 'fas fa-comments',
  'Financial Planning': 'fas fa-money-bill-wave',
  ...
  'Content Generation': 'fas fa-file-alt',
  Journalism: 'fas fa-newspaper',
  'Technical Writing': 'fas fa-file-code',
  Critique: 'fas fa-comment-dots',
  Editing: 'fas fa-edit',
  Screenwriting: 'fas fa-film',
  Humanities: 'fas fa-book',
  STEM: 'fas fa-flask',
  'Learning Aids': 'fas fa-chalkboard-teacher',
  'Language Learning': 'fas fa-language',
  'Career Development': 'fas fa-briefcase',
  'Religious Studies': 'fas fa-cross',
  'Critical Thinking': 'fas fa-brain',
  'Academic Review': 'fas fa-graduation-cap',
  Gaming: 'fas fa-gamepad',
  Humor: 'fas fa-laugh-beam',
  'Interactive Stories': 'fas fa-book-reader',
  Music: 'fas fa-music',
  Travel: 'fas fa-plane',
  'Personal Health & Wellness': 'fas fa-heart',
  'Personal Planning': 'fas fa-calendar-alt',
  'Hobbyist Projects': 'fas fa-wrench',
  'Pet Care': 'fas fa-paw',
  'Travel Planning': 'fas fa-suitcase-rolling',
  'Administrative Assistance': 'fas fa-clipboard-list',
  'Project Management': 'fas fa-tasks',
  'Scientific Research': 'fas fa-microscope',
  'Engineering Solutions': 'fas fa-cogs',
  'Medical Research': 'fas fa-staff-snake',
  'Social Media Content': 'fas fa-share-alt',
  'SEO Optimization': 'fas fa-search',
  Branding: 'fas fa-trademark',
  'Sales Techniques': 'fas fa-dollar-sign',
  'Software Development': 'fas fa-code',
  'Information Security': 'fas fa-shield-alt',
  'Database Management': 'fas fa-database',
  'Information Technology': 'fas fa-server',
  Blockchain: 'fas fa-coins',
  'Artificial Intelligence': 'fas fa-robot',
  'Developer Relations': 'fas fa-handshake',
  'Software Quality Assurance': 'fas fa-bug',
}
